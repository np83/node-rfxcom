...
/*jshint -W104 */ // Bitwise
var definesCurtain = require("./defines");
/*
...
Curtain1.prototype._sendCommand = function (deviceId, command, callback) {
    ...
    var buffer = [0x07, defines.CURTAIN1, 0x00, cmdId, device.houseCode, device.unitCode, command, 0];
...
Curtain1.prototype.open = function (deviceId, callback) {
    return this._sendCommand(deviceId, definesCurtain.CURTAIN_OPEN, callback);
};
/*
 * Close deviceId.
 */
Curtain1.prototype.close = function (deviceId, callback) {
    return this._sendCommand(deviceId, definesCurtain.CURTAIN_CLOSE, callback);
};
/*
 * Stop deviceId.
 */
Curtain1.prototype.stop = function (deviceId, callback) {
    return this._sendCommand(deviceId, definesCurtain.CURTAIN_STOP, callback);
};
/*
 * Open deviceId.
 */
Curtain1.prototype.program = function (deviceId, callback) {
    return this._sendCommand(deviceId, definesCurtain.CURTAIN_PROGRAM, callback);
};
//# sourceMappingURL=curtain1.js.map