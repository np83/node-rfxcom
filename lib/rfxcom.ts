...
function RfxCom(device: IRfxComDevice, options : IOptions) {
    var self: IRfxCom = this;
...
(<IRfxCom>RfxCom.prototype).open = function() {
    var self : IRfxCom = this;
...
(<IRfxCom>RfxCom.prototype).messageHandler = function(data) {
    var self  :IRfxCom = this,
        subtype = data[0],
        seqnbr = data[1],
        responses = {
...
(<IRfxCom>RfxCom.prototype).initialise = function(callback) {
    var self : IRfxCom = this;
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).statusHandler = function(data) {
    var self: IRfxCom = this,
        receiverTypes = {
            0x50: "310MHz",
            0x51: "315MHz",
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).getCmdNumber = function () {
    var self: IRfxCom = this;
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).sendMessage = function(type, subtype, cmd, extra, callback) {
    var self: IRfxCom = this;
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).reset = function(callback) {
    var self : IRfxCom = this;
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).flush = function(callback) {
    var self: IRfxCom = this;
 ...
 */
(<IRfxCom>RfxCom.prototype).getStatus = function(callback) {
    var self : IRfxCom = this;
 ...
 */
(<IRfxCom>RfxCom.prototype).enable = function(protocols, callback) {
    var self: IRfxCom = this;
 ...
 */
(<IRfxCom>RfxCom.prototype).save = function(callback) {
    var self: IRfxCom = this;
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).delay = function(ms) {
    ms += +new Date();
    while (+new Date() < ms) {
        // Do nothing...
    }
...
(<IRfxCom>RfxCom.prototype).dumpHex = function(buffer, prefix) {
    prefix = prefix || "";
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).bytesToUint32 = function(bytes) {
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).bytesToUint48 = function(bytes) {
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).stringToBytes = function(bytes) {
    var result : number[] = [],
        byteString : string,
        value : number,
        i;
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).elec23Handler = function(data) {
    var self: IRfxCom = this;
    var TOTAL_DIVISOR = 223.666,
        subtype = data[0],
        seqnbr = data[1],
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).security1Handler = function(data) {
    var self: IRfxCom = this;
    var subtype = data[0],
        seqnbr = data[1],
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).temp19Handler = function(data) {
    var self : IRfxCom = this;
    var subtype = data[0],
        seqnbr = data[1],
        id = "0x" + self.dumpHex(data.slice(2, 4), false).join(""),
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).temphumidity19Handler = function(data) {
    var self :IRfxCom = this;
    var subtype = data[0],
        seqnbr = data[1],
        id = "0x" + self.dumpHex(data.slice(2, 4), false).join(""),
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).lighting1Handler = function(data) {
    var self :IRfxCom = this,
        subtypes = {
            0: "X10",
            1: "ARC",
        ...
        subtype : string = subtypes[data[0]],
        seqnbr = data[1],
        housecode = String.fromCharCode(data[2]),
        unitcode = data[3],
        command : string = commands[data[4]],
        rssi = data[5] >> 4,
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).lighting2Handler = function(data) {
    var self = this;
    var commands = {
            0: "Off",
            1: "On",
        ...
        unitcode = data[6],
        command : string = commands[data[7]],
        level = data[8],
        rssi = (data[9] & 0xf0) >> 4,
        evt: ILighting2Event;
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).lighting5Handler = function(data) {
    var self : IRfxCom = this;
    var subtypes = {
 ...
 /**
   ...
   *
   */
(<IRfxCom>RfxCom.prototype).rfxmeterHandler = function(data) {
  var self : IRfxCom = this,
      id = "0x" + self.dumpHex(data.slice(2, 4), false).join(""),
...
/**
  ...
  *
  */
(<IRfxCom>RfxCom.prototype).weightHandler = function(data) {
  var self = this,
      id = "0x" + self.dumpHex(data.slice(2, 4), false).join(""),
      batterySignalLevel = data[6],
      evt :IWeightEvent = {
...
/**
  ...
  *
  */
(<IRfxCom>RfxCom.prototype).rfxsensorHandler = function(data) {
	var self :IRfxCom = this;
	var subtype = data[0];
	var seqnbr = data[1];
	var id = "0x" + self.dumpHex([data[2]], false).join("");
    var evt: IRfxComSensorEvent = {
        subtype: subtype,
        id: id,
        seqnbr: seqnbr,
        rssi: data[5] >> 4,
 ...
 *
 */
(<IRfxCom>RfxCom.prototype).tempbaro12Handler = function(data) {
   var self : IRfxCom = this,
       id = "0x" + self.dumpHex(data.slice(2, 4), false).join(""),
       temperature = ((data[4] & 0x7f) * 256 + data[5]) / 10,
       signbit = data[4] & 0x80,
